...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9416&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sklearn-crfsuite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sklearn-crfsuite` can be installed with:

```
conda install sklearn-crfsuite
```

It is possible to list all of the versions of `sklearn-crfsuite` available on your platform with:
